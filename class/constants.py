...
characters      = ConfigJson.file_map(constants, "characters")
objects         = ConfigJson.file_map(constants, "object")

FILE_MAP        = constants.get("file_map")
NB_SPRITES      = constants.get("nb_sprites")
SIZE_SPRITES    = constants.get("size_sprites")
LOGO            = constants.get("logo")
ICONE           = constants.get("icone")
...
GUARDIAN        = guardian["file_picture"]
